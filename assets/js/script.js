...
$(document).ready(function() {
        ...
        $(this).find('[required]').each(function() {
            if ($(this).val().trim() === '') {
                ...
                if (!$(this).next('.error-message').length) {
                    $(this).after('<span class="error-message" style="color: var(--primary); font-size: 0.85rem; margin-top: 5px; display: block;">This field is required</span>');
                }
            } else {
    ...
    // ==================== CONSOLE MESSAGE ====================
    console.log('%c AMG Transport Solutions ', 'background: linear-gradient(135deg, #C41E3A, #E8334A); color: white; font-size: 18px; font-weight: bold; padding: 10px 20px; border-radius: 5px;');
    console.log('%c Global Freight Forwarding & Shipping Services ', 'color: #6B7280; font-size: 12px;');
    ...
    $('.nav-link, .mobile-nav-link, .btn-primary, .btn-secondary').on('keypress', function(e) {
